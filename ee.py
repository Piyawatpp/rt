...
""")
	...
	print ("")
	print ("CREDIT : คาเวียร์")
	print ("ทำโดย : คาเวียร์ พลังท่อม")
	print ("ลิงค์เฟสบุ๊ค >>> https://www.facebook.com/profile.php?id=100050270165634")
	print ("")
	phone = input("\33[1;96m เบอร์ : \033[0m")
	num=int(input("\33[1;96m จำนวน : \033[0m"))
